...
- Python 3.14 + `python-telegram-bot[job-queue]` ≥21.0, `google-genai` ≥1.14.0 (001-gemini-image-bot)
...
- 001-gemini-image-bot: Added Python 3.14 + `python-telegram-bot[job-queue]` ≥21.0, `google-genai` ≥1.14.0
